...
export const generarFacturaPDF = async (facturaData, detallesPedido) => {
    try {
        ...
        doc.text("Marthita's Snack", 105, currentY, null, null, 'center');
        currentY += 10;
        ...
        doc.text("Gracias por su compra - Marthita's Snack", 105, 280, null, null, 'center');
        doc.text("Teléfono: 12345678 - Dirección: Av. Siempre Viva 123", 105, 285, null, null, 'center');
