    ...
    const testimonios = [
        {
            id: 1,
            nombre: "Juan Pérez",
            comentario: "Las mejores hamburguesas de la ciudad. Siempre frescas y deliciosas.",
            rating: 5,
        ...
        },
        {
            id: 2,
            nombre: "María Gómez",
            comentario: "Excelente servicio y la comida siempre llega caliente. 100% recomendado.",
            rating: 5,
            fecha: "Hace 1 mes"
        },
        {
            ...
            comentario: "Mi lugar favorito para comer rápido y rico. Los precios son justos.",
            rating: 4,
            fecha: "Hace 3 días"
        }
    ];
