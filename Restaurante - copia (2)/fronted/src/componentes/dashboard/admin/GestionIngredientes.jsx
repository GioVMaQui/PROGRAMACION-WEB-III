                            ...
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input
                                        ...
                                        placeholder="Ej: Tomate, Queso, Pan"
                                        required
                                    />
                                </div>
                                ...
                                {ingredientes.length === 0 ? (
                                    ...
                                    ingredientes.map(ing => (
                                        <tr key={ing.idIngrediente}>
                                            ...
                                            <td>
                                                <strong>{ing.nombreI}</strong>
                                            </td>
                                            <td>
                                                <span className="fw-bold">{ing.stock}</span>
                                            </td>
                                            <td>
                                                <span className={`badge bg-${getStockColor(ing.stock)}`}>
                                                    {getStockText(ing.stock)}
                                                </span>
                                            </td>
                                            <td>
                                                {ing.unidadMedida || '-'}
                                            ...
                                            <td>
                                                <div className="btn-group btn-group-sm">
                                                    ...
                                                    <button 
                                                        ...
                                                        onClick={() => handleEliminar(ing.idIngrediente)}
                                                        title="Eliminar"
                                                    >
                                                        Eliminar
                                                    </button>
                ...
                <div className="col-md-4">
                    <div className="card text-white bg-warning">
                        <div className="card-body">
                            ...
                            <h2>
                                {ingredientes.filter(i => i.stock < 5).length}
                            </h2>
                            <p className="card-text">ingredientes</p>
                        </div>
                    </div>
                ...
                <div className="col-md-4">
                    <div className="card text-white bg-danger">
                        <div className="card-body">
                            ...
                            <h2>
                                {ingredientes.filter(i => i.stock === 0).length}
                            </h2>
                            <p className="card-text">ingredientes</p>
                        </div>
                    </div>
