...
import GestionIngredientes from './GestionIngredientes.jsx';
    ...
    return (
        <div className="dashboard-admin d-flex">
            ...
            <div className="sidebar bg-dark text-white p-3" style={{width: '250px', minHeight: '100vh'}}>
                <h4 className="text-center mb-4">Marthita's Snack</h4>
                ...
                <nav className="nav flex-column">
                    ...
                    <Link to="/admin/ingredientes" className="nav-link text-white mb-2">Ingredientes</Link>
                    <Link to="/admin/pedidos" className="nav-link text-white mb-2">Pedidos</Link>
                    <Link to="/admin/facturas" className="nav-link text-white mb-2">Facturas</Link>
                    <Link to="/admin/impresiones" className="nav-link text-white mb-2">Impresiones</Link>
                    <hr className="bg-light" />
            ...
            <div className="content flex-grow-1 p-4">
                <Routes>
                                ...
                                <div className="col-md-3 mb-3">
                                    <div className="card text-white bg-warning">
                                        <div className="card-body">
                                            ...
                                            <p className="card-text">Control de stock</p>
                                            <Link to="/admin/ingredientes" className="btn btn-light">Ver</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-3 mb-3">
                                    <div className="card text-white bg-info">
                                        <div className="card-body">
                                            ...
                                            <p className="card-text">Ver todos los pedidos</p>
                                            <Link to="/admin/pedidos" className="btn btn-light">Ver</Link>
                                        </div>
                                    </div>
                                </div>
                                {/* Tarjeta para Impresiones */}
                                <div className="col-md-3 mb-3">
                    ...
                    <Route path="/impresiones" element={<GestionImpresiones />} /> {/* AÑADE ESTA RUTA */}
                    
                    {/* Rutas para edición */}
                    <Route path="/productos/nuevo" element={
                        <div>
                            <h2>Nuevo Producto</h2>
                            {/* Aquí va el formulario de nuevo producto */}
                        </div>
                    } />
