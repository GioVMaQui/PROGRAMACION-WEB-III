...
import ingredienteRutas from './rutas/ingredienteRutas.js';
import productoIngredienteRutas from './rutas/productoIngredienteRutas.js';
...
app.use('/api/ingredientes', ingredienteRutas);
app.use('/api/producto-ingredientes', productoIngredienteRutas);

app.get('/', (req, res) => {
    res.json({ mensaje: 'API funcionando', rutas: ['/api/usuarios', '/api/usuarios/login'] });
});
